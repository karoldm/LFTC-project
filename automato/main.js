...
function init() {
    ...
    convertToER.addEventListener("click", () => {
        ...
        */
        ...
        let linksVisited = [];
        getExprReg(currState, expressions, nextStates, "", linksVisited);
     ...
     */
    function getExprReg(currState, expressions, nextStates, exprStr, linksVisited) {
        ...
        while (nextStates.length > 0) {
            ...
            if (nextStates.length > 0) {
                ...
                getExprReg(newCurrState, expressions, newNextStates, newExprStr, linksVisited);
